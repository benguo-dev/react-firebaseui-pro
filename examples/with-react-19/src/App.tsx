...
import ReactFirebaseUIPro from 'react-firebaseui-pro';
import './App.css';
...
function App() {
  const [isSignedIn, setIsSignIn] = useState<boolean | undefined>(undefined);
  ...
  return (
    <>
      {isSignedIn !== undefined && !isSignedIn && <ReactFirebaseUIPro uiConfig={uiConfig} firebaseAuth={firebaseApp.auth()} className="firebaseui-icon"/>}
      {isSignedIn && user &&
